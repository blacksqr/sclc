...
;; Last Modified On: Thu Aug 25 14:52:42 2005
...
(defvar hackystat-version "@hackystat.version@"
  "Token that is replaced by the actual hackystat release number by the Ant packageEmacs task.")

(defvar hackystat-buildtime "@hackystat.buildtime@"
  "Token that is replaced by the actual hackystat build time by the Ant packageEmacs task.")
